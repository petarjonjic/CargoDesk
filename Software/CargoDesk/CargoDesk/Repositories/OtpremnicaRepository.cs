...
namespace CargoDesk.Repositories
{
    public static class OtpremnicaRepository
    {
        ...
        public static async Task<int> InsertOtpremnicaAsync(Otpremnica o)
        {
            await using var conn = await Database.OpenConnectionAsync();
            await using var cmd = new NpgsqlCommand(@"
            ...
            cmd.Parameters.AddWithValue("@bnk",
                string.IsNullOrWhiteSpace(o.BrojNarudzbeniceKupca) ? (object)DBNull.Value : o.BrojNarudzbeniceKupca);
            cmd.Parameters.AddWithValue("@brk",
                string.IsNullOrWhiteSpace(o.BrojRacunaKupca) ? (object)DBNull.Value : o.BrojRacunaKupca);
            cmd.Parameters.AddWithValue("@nap",
                string.IsNullOrWhiteSpace(o.Napomena) ? (object)DBNull.Value : o.Napomena);
